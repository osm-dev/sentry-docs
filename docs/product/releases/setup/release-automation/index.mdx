...
The list above include all platforms currently supported by Automatic Release Management, if your platform is not included you must use the [manual process](/product/releases/associate-commits/) to integrate release data.
